...
namespace TestBinding {
	[Register("Controller", true)]
	public unsafe partial class Controller : NSObject {
		[CompilerGenerated]
		const string selHelloWorld = "helloWorld";
		static readonly IntPtr selHelloWorldHandle = Selector.GetHandle ("helloWorld");
		
		[CompilerGenerated]
		static readonly IntPtr class_ptr = Class.GetHandle ("Controller");
		...
		[Export ("init")]
		public Controller () : base (NSObjectFlag.Empty)
		{
		...
		public Controller (NSCoder coder) : base (NSObjectFlag.Empty)
		{
			IsDirectBinding = GetType ().Assembly == global::testbinding.Messaging.this_assembly;
			if (IsDirectBinding) {
		...
		[CompilerGenerated]
		[EditorBrowsable (EditorBrowsableState.Advanced)]
		public Controller (NSObjectFlag t) : base (t)
		{
			IsDirectBinding = GetType ().Assembly == global::testbinding.Messaging.this_assembly;
		}
